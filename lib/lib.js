...
Array.prototype.$_first = function(queryOrFunction) {
    ...
    if (queryOrFunction) {
        items = utils.performSearch(Array.prototype.filter.bind(items), queryOrFunction);
    }
...
Array.prototype.$_count = function(queryOrFunction) {
    ...
    if (queryOrFunction) {
        return utils.performSearch(Array.prototype.filter.bind(this), queryOrFunction).length;
    }
    else {
        return this.length;
    }
