...
var sumAges = customers.$_sum('age');
console.log('Sum of all ages is: ' + sumAges);
console.log('Max age: ' + customers.$_max('age'));
console.log('Min age: ' + customers.$_min('age'));
console.log('Average age: ' + customers.$_average('age'));
console.log('Total customers: ' + customers.$_count());